...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Program.member_of'
        db.alter_column('web_program', 'member_of_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Series'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Program.member_of'
        db.alter_column('web_program', 'member_of_id', self.gf('django.db.models.fields.related.ForeignKey')(default=False, to=orm['web.Series']))
