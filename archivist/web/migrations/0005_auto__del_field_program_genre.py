...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Program.genre'
        db.delete_column('web_program', 'genre_id')

        # Adding M2M table for field genres on 'Program'
        db.create_table('web_program_genres', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('program', models.ForeignKey(orm['web.program'], null=False)),
            ('genre', models.ForeignKey(orm['web.genre'], null=False))
        ))
        db.create_unique('web_program_genres', ['program_id', 'genre_id'])


    def backwards(self, orm):
        
        # Adding field 'Program.genre'
        db.add_column('web_program', 'genre', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['web.Genre']), keep_default=False)

        # Removing M2M table for field genres on 'Program'
        db.delete_table('web_program_genres')
