...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Source.tracks'
        db.alter_column('web_source', 'tracks', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Source.tracks'
        db.alter_column('web_source', 'tracks', self.gf('django.db.models.fields.IntegerField')(default=False))
