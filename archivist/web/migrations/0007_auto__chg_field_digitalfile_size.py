...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DigitalFile.size'
        db.alter_column('web_digitalfile', 'size', self.gf('django.db.models.fields.FloatField')())


    def backwards(self, orm):
        
        # Changing field 'DigitalFile.size'
        db.alter_column('web_digitalfile', 'size', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        'web.digitalfile': {
            ...
            'size': ('django.db.models.fields.FloatField', [], {'blank': 'True'}),
