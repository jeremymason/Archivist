...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Source.number'
        db.alter_column('web_source', 'number', self.gf('django.db.models.fields.CharField')(max_length=50))


    def backwards(self, orm):
        
        # Changing field 'Source.number'
        db.alter_column('web_source', 'number', self.gf('django.db.models.fields.IntegerField')())
